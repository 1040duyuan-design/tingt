...
- can turn a messy issue into metrics, rules, and a next-step plan
- prefers measurable effect over empty discussion
- naturally asks what the real bottleneck is
